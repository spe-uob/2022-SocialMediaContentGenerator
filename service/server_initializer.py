...
init_web_components: [Component] = [Index, GetTasks, GetTxt2ImgTasks, VRAM, ModelList, LoadModel, CurrentModel, SamplerList, Txt2Img, Txt2ImgResult, Image, TwitterBackEnd, TwitterAuth, TwitterSignInCheck, TwitterSignOut, LinkedInApi, LinkedInApiPost, openAiApi, linkedinSignOut, LinkedInApiPostImage]
