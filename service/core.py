...
class Core:
    def __init__(self, config: dict):
        ...
        self.device = torch.device("cpu")  # torch.device("cuda" if torch.cuda.is_available() and not self.force_cpu else "cpu")
    ...
    def optimize_memory(self):
        self.memory_optimizer.apply_memory_optimizations(CorsAttentionOptimizationMode.V1)
